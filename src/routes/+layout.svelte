...
<header class="sticky shadow-xl dark:shadow-indigo-500/50 top-0 z-50 ">
	...
	<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
		...
		<a href="/" class="flex items-center">
			<img src="/images/aster.webp" class="h-8 mr-3" alt="Asterisc Logo">
		...
		<div class=" {isOpen ? '' : hidden} items-center justify-between  w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
