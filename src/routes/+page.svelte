...
<main class="dark:bg-gray-800 bg-gray-100  dark:text-gray-100">
	<div class="bg-gray">
		<div class="relative isolate px-6 py-16 md:py-2">
			<div
				...
				<div class="text-center">
					...
					<div class="mt-6 flex gap-x-4">
						...
						<input
							...
							autocomplete="email"
							required
							class="min-w-0 border-black flex-auto rounded-md bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
